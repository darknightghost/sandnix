...
static	pkstring_obj_t	to_string(pepagewrite_except_t p_this);
static	void			panic(pepagewrite_except_t p_this);

pepagewrite_except_t epagewrite_except(address_t fault_addr)
{
...
pkstring_obj_t to_string(pepagewrite_except_t p_this)
{
    pkstring_obj_t p_ret = kstring_fmt(
                               "%s\n"
                               "Failed to write memory at %p.",
                               p_except_obj_heap,
...
void panic(pepagewrite_except_t p_this)
{
    //Get call stack
    list_t bt_lst;

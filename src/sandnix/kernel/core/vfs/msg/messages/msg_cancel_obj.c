...
pmsg_cancel_obj_t msg_cancel_obj(
    pmsg_obj_t p_canceld_msg,
    pheap_t heap)
{
    pmsg_cancel_obj_t p_ret = (pmsg_cancel_obj_t)msg_obj(
                                  MSG_MJ_COMPLETED,
                                  0,
                                  MSG_ATTR_ASYNC,
                                  NULL,
                                  sizeof(msg_cancel_obj_t),
                                  heap);
    ...
    //Variables
    p_ret->p_canceld_msg = p_canceld_msg;

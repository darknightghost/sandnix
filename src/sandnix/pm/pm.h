...
#define		PRIORITY_DRVNORMAL	((PRIORITY_HIGHEST - PRIORITY_NORMAL) / 2 + PRIORITY_NORMAL)
...
//Thread
void		pm_schedule();
u32			pm_create_thrd(thread_func entry, bool is_ready,
                           bool is_user, u32 priority, void* p_args);
